...
<body>
    <header class="text-gray-600 body-font">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
                ...
                <a class="mr-5 hover:text-gray-900 hover:cursor-pointer text-black">Customers</a>
    ...
    <a href="add_customer.php" class="float-right mr-[4.5rem] inline-flex items-center bg-blue-500 border-0 py-2 px-5 focus:outline-none hover:bg-blue-600 text-white rounded shadow text-base mt-4 md:mt-0 
                font-thin body-font cursor-pointer">Add
        Customer</a>
    <main class="m-12">
